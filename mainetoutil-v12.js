...
document.querySelectorAll('form[data-form]').forEach(form=>form.addEventListener('submit',async e=>{
  ...
  try{
    ...
    if(!response.ok||(result.success!==true&&result.success!=='true'))throw new Error(result.message||'Envoi refusé');
